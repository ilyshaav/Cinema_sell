...
<?php
	...
	header( 'Content-Type: text/html; charset=utf-8' );
		...
		echo '<center>';
		echo '<table class="menuT"><caption></caption><tr><th><b>ID</b></th><th><b>Фамилия</b></th><th><b>Имя</b></th><th><b>Отчество</b></th><th><b>Номер телефона</b></th><th><b>e-mail</b></th></tr></tr>' ;
		echo '</center>';
		$query = "SELECT * FROM $itemstable"; 
		$result = mysqli_query($t,$query) or die(mysqli_error());
