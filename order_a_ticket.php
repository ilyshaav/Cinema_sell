...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" name="order_a_ticket" method="GET"> 
			<font size="4">Номер билета:</font> <input class="b2" type="text" name="id_tickets" size="30"><br>
			<font size="4">Адрес:</font> <input class="b2" type="text" name="adres" size="43"> <br>
			<font size="4">Почтовый индекс:</font> <input class="b2" type="index" name="date" size="35"> <br>
...
<?php
		header( 'Content-Type: text/html; charset=utf-8' );
			...
			$t=mysqli_connect($hostname,$username,$password) OR DIE("ERROR CON "); 	
				...
				$query = "DELETE FROM $itemstable WHERE $id_tickets='$cl_tickets'"; 
